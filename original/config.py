...
config = {
    ...
    "friends": "h",
    "invisible": False,
    "healthPotAtPercent": 0.6,  # health threshold to trigger potion
    ...
    "minimapCenterX": 1772,
    "minimapCenterY": 272,
    "timeLimit": 150000,  # to prevent unexpected amount of time spent in a chaos dungeon, a tiem limit is set here, will quit after this amount of seconds
    "timeLimitAor": 480000,  # to prevent unexpected amount of time spent in a chaos dungeon, a tiem limit is set here, will quit after this amount of seconds
